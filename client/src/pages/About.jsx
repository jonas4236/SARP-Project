          ...
          <div className="lg:xl:w-[800px] xl:w-[800px] mx-auto mt-16">
            ...
            <ul className="mt-8">
              ...
              <div className="ml-4">
                <li>
                  1.
                  เพื่อให้ผู้ปกครองสามารถตรวจสอบการเข้าเรียนของนักเรียนนักศึกษาโดยการใช้โปรแกรม
                  รายงานการเข้าเรียนของนักเรียนนักศึกษา
                </li>
                <li>
                  2.
                  เพื่อเสริมสร้างการสื่อสารระหว่างครูและผู้ปกครองเพื่อเตรียมความพร้อมในการดูแลบุตร
                  หลานของท่านในด้านการศึกษา
                </li>
              </div>
            </ul>
            <ul className="mt-8">
